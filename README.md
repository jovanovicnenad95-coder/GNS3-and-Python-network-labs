...
| **Day 5** | [Multi-Device Loop](./Day5_Multi_Device) | Python Lists, For Loops, Scalability | ✅ Done |
| **Day 6** | [OSPF Packet Analysis](./Day6_OSPF_Wireshark) | Wireshark, OSPF Header, Hello Packet | ✅ Done |
